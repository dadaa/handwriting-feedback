...
var HandwritingFeedback = function() {
}

HandwritingFeedback.prototype.setAudioSource = function(source, loadedListener) {
  var self = this;
...
HandwritingFeedback.prototype.muteTimer = function() {
...
HandwritingFeedback.prototype.start = function(x, y) {
  this.gainControl.gain.value = 1;
  this.muteTimer();
},

HandwritingFeedback.prototype.update = function(x, y) {
  this.muteTimer();
},
  
HandwritingFeedback.prototype.stop = function(x, y) {
